...
static void rem_x_mexFunction(int32_T nlhs, mxArray *plhs[1], int32_T nrhs,
                 ...
                 *prhs[])
{
  ...
  rem_x_mexFunction(nlhs, plhs, nrhs, prhs);
}
...
/*
 * File trailer for _coder_rem_x_mex.c
 *
 * [EOF]
 */
