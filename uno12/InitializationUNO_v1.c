...
//inline static void Chip_Select_Up(void)
//{
//	HAL_GPIO_WritePin(GPIO_X, GPIO_PIN, GPIO_PIN_SET);
//}
//inline static void Chip_Select_Down(void)
//{
//	HAL_GPIO_WritePin(GPIO_X, GPIO_PIN, GPIO_PIN_RESET);
//}
/*variables=========================================================================================================*/
...
const uint8_t initial_mass_7[41] = {
	/*40*/ 0x10, 0x03, 0x00,0x05,0x21,0x20,/*41*/ 0x11, 0x00,/*42*/ 0x10, 0x0C,0x0F,0xFF,
	0x00,0x00,/*43-49; 50*/0x11, 0x00,/*51*/ 0x10, 0x04, 0x0B, 0xA2, 0xE8,0xBA,/*52*/0x10,
	0x06, 0xC6,0x6F, 0x5E,0x22, /*53*/0x10, 0x05, 0x43,0x64,0xC5,0xBB,/*54*/ 0x11, 0x00,
	/*55*/ 0x62, 0x00,0x00,0x00,0x0B
	};	
...
int uno_close (uint8_t uno_index)
{
	...
	/*Обработчик ошибок*/
	uint8_t uno_answer, address = 0x81;
...
*/
/*=============================================================================================================*/
int uno_gain(uint8_t uno_index, float freq, uint8_t gain)
{
	float fr_out = freq;
	uint8_t dB = gain;
	uint8_t n_pow;
	...
	uint8_t K = Search_K(fr_vco2);
	{
		uint8_t data_0[2] = { 0x04, dB }; 
		uint8_t data_1[5] = { 0x62, 0, 0, 0, K };
		SPI_UNO_Transmit(data_0, 2);
		SPI_UNO_Transmit(data_1, 5);
	}
	return UNO_OK;
